...
inpaint_image       = f"asset/bg_replace/{img_id}.jpg"
mask_image_seg          = f"asset/bg_replace/{img_id}_seg_mask.png"
mask_image       = f"asset/bg_replace/{img_id}_bg_mask.png"

img_mask = Image.open(mask_image_seg).convert("L")
...
def save_results():
    ...
    video_path = os.path.join(save_path, img_id + '_' + prefix + ".png")
    image = sample[0]
